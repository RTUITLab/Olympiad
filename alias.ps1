...
function OlympiadDockerComposeStack {
    docker-compose -f .\docker-compose.yml -f .\Olympiad-Back\docker-compose.yml -f .\Olympiad-Back\docker-compose.production.yml -f .\Olympiad-Front\docker-compose.yml $args
}
